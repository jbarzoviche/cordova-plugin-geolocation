...
var geolocation = {
     ...
     * @param {Function} errorCallback      The function to call when there is an error getting the authorization status. (OPTIONAL)
     */
    getAuthorizationStatus: function (successCallback, errorCallback) {
        argscheck.checkArgs('fF', 'geolocation.getAuthorizationStatus', arguments);
        var fail = function (e) {
